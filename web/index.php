...
$stmt = $pdo->query("SELECT * FROM mytask");
...
if (isset($_POST['botonInsertar'])) {
    ...
    $sentencia = $pdo->prepare("INSERT INTO mytask (mytask) VALUES (:nombre)");
    $sentencia->bindParam(':nombre', $tarea);
...
if (isset($id)) {
    ...
    $sentencia = $pdo->prepare("DELETE FROM mytask WHERE id=:id");
